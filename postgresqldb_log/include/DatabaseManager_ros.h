...
public:
   ...
   bool checkIfOnline(std_srvs::Trigger::Request& request, std_srvs::Trigger::Response& response); // true if the request was handled successfully, false otherwise
...
private:
   ...
   std::vector<std::string> update_column;
   std::vector<std::string> update_value;
